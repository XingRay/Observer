...
import com.xingray.observer.field.MutableListField
 ...
 */
@Suppress("unused")
class ObservableMutableList<E : MutableObject, T : MutableList<E>>(
    private val listDataWrapper: MutableListField<E, T>
) : ObservableMutableObject<T, ListObserver<E, T>>(listDataWrapper) {

    constructor(t: T?) : this(MutableListField(t))
    constructor() : this(null)

    fun changeItems(items: kotlin.collections.MutableList<E?>?): Pair<Boolean, List<E?>?>? {
